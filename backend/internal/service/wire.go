...
// ProvideInvalidAccountCleanupService creates and starts InvalidAccountCleanupService.
func ProvideInvalidAccountCleanupService(accountRepo AccountRepository, cfg *config.Config) *InvalidAccountCleanupService {
	svc := NewInvalidAccountCleanupService(accountRepo, cfg)
	svc.Start()
	return svc
}
...
var ProviderSet = wire.NewSet(
	...
	ProvideInvalidAccountCleanupService,
